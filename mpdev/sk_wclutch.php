...
$compWClutchProcesses = [
    'Pre Stator', 'Stator Assy', 'Rotor Assy', 'Washer Selection', 'Bracket Assy', 
    'Final Check WClutch', 'Packaging', 'Mizusumashi WClutch', 'Repair Man WClutch', 'Prepare Bracket'
];

// Calculate stats
$totalEmployees = count($compWClutchData);
$totalProcesses = count($compWClutchProcesses);
$totalSkills = 0;
$completedSkills = 0;
$expertSkills = 0;
...
<div class="main-content">
  ...
  <div class="page-header fade-in">
    <div class="d-flex justify-content-between align-items-start flex-wrap">
      <div class="mb-3">
        <h1 class="page-title">🔧 Skill Matrix - WClutch</h1>
        <p class="page-subtitle">Evaluasi kemampuan karyawan berdasarkan <?= count($compWClutchProcesses) ?> proses kerja WClutch</p>
      </div>
  ...
  <div class="stats-container fade-in">
    <div class="stat-card">
      <div class="stat-value"><?= count($compWClutchProcesses) ?></div>
  ...
  <div class="info-card fade-in">
    <div class="d-flex align-items-center mb-3">
      ...
      <strong style="color: #1e293b; font-size: 1.1rem;">Panduan Skill Matrix WClutch</strong>
    </div>
    <p style="color: #64748b; margin-bottom: 15px;">
      Sistem evaluasi khusus untuk proses WClutch dengan fokus pada presisi dan kualitas output.
    </p>
  ...
  <div class="filter-card fade-in">
    ...
    <form method="GET" class="row g-3">
      ...
      <div class="col-md-4 d-flex align-items-end">
        ...
        <a href="sk_wclutch.php" class="btn-reset">🔄 Reset</a>
      </div>
    </form>
  </div>
    ...
    <div class="table-container">
      <table class="table table-bordered skill-matrix-table">
        ...
        <tbody>
          ...
          <?php if (empty($compWClutchData)): ?>
          <tr>
            <td colspan="<?= count($compWClutchProcesses) + 6 ?>" class="text-center" style="padding: 40px;">
              <div style="color: #64748b;">
                <i class="fas fa-info-circle" style="font-size: 2rem; margin-bottom: 10px;"></i>
                <p>Tidak ada data karyawan yang ditemukan untuk section Comp WClutch</p>
              </div>
            </td>
          </tr>
          <?php endif; ?>
...
<script>
// WClutch processes array from PHP
...
function scrollToCurrentProcess(npk, currentProcesses) {
    ...
    if (processIndex !== -1) {
        ...
        if (targetCell) {
            ...
            targetCell.style.boxShadow = '0 0 15px rgba(220, 38, 38, 0.8)';
            setTimeout(() => {
